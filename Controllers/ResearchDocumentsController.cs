...
namespace EMIAS_API.Controllers
{
    ...
    public class ResearchDocumentsController : ControllerBase
    {
        ...
        public ResearchDocumentsController(EmiasDbContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != researchDocument.IdResearch)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<ResearchDocument>> PostResearchDocument(ResearchDocument researchDocument)
        {
            ...
            return CreatedAtAction("GetResearchDocument", new { id = researchDocument.IdResearch }, researchDocument);
        }
        ...
        {
            return _context.ResearchDocuments.Any(e => e.IdResearch == id);
        }
    }
}
